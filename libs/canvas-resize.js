(function(window) {
    ...
    Plugin.prototype = {
        init: function() {
            ...
            if (typeof file === "string") {
                loadImageAndResize.call($this, file, {});
            } else {
                ...
                reader.onloadend = function(e) {
                    ...
                    if (dataURL.indexOf("data:image/") > -1)
                        ...
                        dataURL = dataURL.replace("data:", "data:image/jpg;");

                    loadImageAndResize.call($this, dataURL, exif);
                    // =====================================================
                };
    ...
    function loadImageAndResize(src, exif) {
        var $this = this;
        var img = new Image();
        img.onload = function(e) {
            ...
            //console.log(size.cropped, width, height);
            ...
            // CALLBACK 鏁版嵁閮ㄥ垎閮藉湪杩欓噷浜�
            $this.options.callback(newcanvas, newcanvas.width, newcanvas.height);
    ...
    if (typeof define == "function" && define.amd) {
        ...
        window[pluginName] = canvasResize;
    }
